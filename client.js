...
function showCategory(category) {
    ...
    if (category=="melodic") {
        ...
        $("#beatsText").replaceWith('<p id="beatsText"> Emotional trap beats inspired by melodic rappers such as Juice WRLD, Iann Dior, The Kid LAROI and Internet Money. Download the tagged version of any beat for free from my <a class="hyperlink" href="https://www.beatstars.com/freo_beats/" target="_blank"> BeatStars page</a>. </p>');
        ...
        $("#beatsText").replaceWith("<p id='beatsText'> Hard hitting drums and gliding 808's! Beats inspired by the UK and NY drill scenes. Download the tagged version of any beat for free from my <a class='hyperlink' href='https://www.beatstars.com/freo_beats/' target='_blank'> BeatStars page</a>. </p>");
        ...
        $("#beatsText").replaceWith("<p id='beatsText'> Massive 808's and dark melodies! Trap beats inspired by artists such as Travis Scott, Denzel Curry, Gunna and Kid Cudi. Download the tagged version of any beat for free from my <a class='hyperlink' href='https://www.beatstars.com/freo_beats/' target='_blank'> BeatStars page</a>. </p>");
